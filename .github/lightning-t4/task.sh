...
DISPLAY="${DISPLAY_VALUE}" xdpyinfo >/dev/null 2>&1 || { echo "FIRST REAL BLOCKER: Xvfb display unusable"; exit 1; }
echo "DISPLAY=${DISPLAY_VALUE}"
echo "XVFB_PID=${xvfb_pid}"
DISPLAY="${DISPLAY_VALUE}" xdpyinfo 2>/dev/null | grep -E 'vendor string:|dimensions:' | head -n 4
